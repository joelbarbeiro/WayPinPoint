...
<?php $this->beginPage() ?>
    ...
    <header>
        ...
        echo '<div class="col-lg-6 text-center mx-auto">';
        echo Html::beginForm(['/site/search'], 'get', ['class' => 'form-inline']);
        echo Html::textInput('search', '', ['class' => 'form-control', 'placeholder' => 'Search for products']);
        echo Html::submitButton('<i class="fa fa-search"></i>', ['class' => 'input-group-text bg-transparent text-primary']);
        echo Html::endForm();
        echo '</div>';
