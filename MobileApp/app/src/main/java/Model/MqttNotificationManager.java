    ...
    public void onMessageReceived(String topic, String mqttMessage) {
        ...
        switch (topic) {
            ...
            case MQTT_REVIEW_CREATE:
                Review createReview = ReviewJsonParser.parserJsonReview(mqttMessage);
                String reviewMessage = "Rating " + createReview.getScore() + " Message " + createReview.getMessage() + " Creation Date: " + createReview.getCreatedAt() + " Author: " + createReview.getCreator();
                sendNotification("New Review " + createReview.getMessage(), reviewMessage);
                break;
            case MQTT_REVIEW_UPDATE:
                Review updateReview = ReviewJsonParser.parserJsonReview(mqttMessage);
                String reviewUpdateMessage = "Rating " + updateReview.getScore() + " Message " + updateReview.getMessage() + " Creation Date: " + updateReview.getCreatedAt() + " Author: " + updateReview.getCreator();
                sendNotification("Updated Review " + updateReview.getMessage(), reviewUpdateMessage);
                break;
            default:
                break;
